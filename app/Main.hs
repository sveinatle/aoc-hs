...
main :: IO ()
main = do
  let days = [Day01.problems, Day02.problems, Day03.problems, Day04.problems, Day05.problems, Day06.problems, Day07.problems, Day08.problems, Day09.problems, Day10.problems, Day11.problems]
  args <- getArgs
  case args of
    [dayStr] -> do
